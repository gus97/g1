...
@XmlRootElement(name = "deleteContSendResponse")
public class DeleteContSendResponse {

	@XmlElementRef(name = "return", namespace = "http://services.ws.lis.sinosoft.com", type = JAXBElement.class)
